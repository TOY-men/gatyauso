[_tb_system_call storage=system/_scene3_K1.ks]

[iscript]
;デバッグ用のスクリプトなので、配布時には消します
f.name_V='ヴェノム先生';
f.name_R='らーば先輩';
f.name_K='かえるくん';
f.name_T='とーますくん';
...
[wait  time="1000"  ]
[ptext  layer=2  name="daytime"  x="300"  y="280"  width="700px"  align="center"  time="1500"  text="12/14　朝8:15"  ]
...
[wait  time="700"  ]
[playse  volume="10"  time="2000"  buf="0"  storage="kyousitu_gayagaya.mp3"  ]
[stopse  time="2000"  buf="0"  fadeout="true"  ]
[tb_start_tyrano_code]
[chara_config talk_focus="none"]
[_tb_end_tyrano_code]

[chara_show  name="あーけんちゃん"  time="300"  wait="false"  storage="chara/8/ABody.png"  width="700"  height="720"  ]
[chara_part  name="あーけんちゃん"  time="1"  face="A_nikkori.png"  wait="true"  ]
[tb_start_text mode=1 ]
;[12月14日][p]
;[8:15 朝 教室][p]
#&f.name_A
「[emb exp="f.name"]ちゃ〜ん、放課後暇だったりする？」[p]
#&f.name
「うん暇だよ、どうしたの？」[p]
[_tb_end_text]
...
「どうしたの？」[p]
#&f.name_A
「僕の友達、サッカー部のマネージャーなんだけど、昨日骨折で入院しちゃってさぁ。今日行けなくなっちゃって」[p]
「なんか[emb exp="f.name"]ちゃんマネージャーとか得意そうだから代わり頼めないかなぁって……」[p]
#&f.name
「私マネージャーとかしたことないんだけど…？！」[p]
#&f.name_A
「大丈夫だよ！ちょっと練習の様子とか見とけばいいだけだから！」[p]
「本当はマネージャー2人いるんだけど、[p]
もう片方は放課後に委員会があるらしくて～終わったらすぐ来てくれるって！」[p]
#&f.name
「私サッカーのルールよく知らないんだけど……というかそれあーけんちゃんが行けばいいんじゃ━━」[p]
[_tb_end_text]
...
#&f.name
「っ！？！？」[p]
な、か、かえるくん！？それは激アツ！で、でもかえるくんにルールがわからない醜態なんて晒したくない……[p]
#&f.name_A
「[emb exp="f.name"]ちゃんかわいいし、すぐみんなと仲良くできると思うんだけどダメ？」[p]
#&f.name
「…やっちゃおうかな〜！」[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#&f.name_A
「うん、じゃあ今日と、なんかあったら別の日も頼むね！」[p]
#&f.name
ん？これ、勝手に別の日もやることになってない？え、騙されてるってやつ……？[p]
[_tb_end_text]
...
[bg  time="1000"  method="fadeInDown"  storage="back/ground.yugata.png"  cross="true"  ]
[wait  time="1000"  ]
[ptext  layer=2  name="daytime"  x="300"  y="280"  width="700px"  align="center"  time="1500"  text="放課後　16:45"  ]

[wait  time="1000"  ]
[tb_ptext_hide  time="1000"  ]
[ptext  layer=2  name=place  x="30"  y="20"  text='<span>グラウンド</span>'  ]
...
[tb_show_message_window  ]
[wait  time="500"  ]
[playse  volume="10"  time="1000"  buf="0"  storage="guraunndo.mp3"  ]
[stopse  time="4000"  buf="0"  fadeout="true"  ]
[tb_start_text mode=1 ]
;[16:45 グラウンド][p]
;[～放課後～とか文字出したいです][p]
#&f.name
とりあえず体操着に着替えてグラウンドに来たはいいものの……誰になんて声かければいいんだ？[p]
てか冬の放課後ってさっっむい！これから日が沈むまで部活するとか私どっかで凍死するんじゃない？！[p]
[_tb_end_text]

[chara_show  name="かえるくん"  time="200"  wait="false"  storage="chara/4/Kb_buk-J.png"  width="700"  height="720"  ]
[chara_part  name="かえるくん"  time="200"  face="K_odoroki.png"  wait="false"  mouse="none"  eye="none"  accessory="none"  face_H="none"  accessory_H="none"  ]
[tb_start_text mode=1 ]
#&f.name_K
「あれ、あれあれあれ？どこかで見たことある顔ですね」[p]
#&f.name
「そ、その声は！」[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#&f.name_K
「呼ばれて飛び出てじゃじゃじゃーん。こんな所でなにしてるんですか？」[p]
#&f.name
き、来た、かえるくん！呼んでないけど飛び出てきてくれたらしい！ありがとう！1人でも話せる人が居てよかった。[p]
「なにって、サッカー部待ってるんだけど……」[p]
[_tb_end_text]

[chara_part  name="かえるくん"  time="200"  face="K_odoroki.png"  mouse="none"  eye="none"  accessory="none"  face_H="none"  accessory_H="none"  ]
[tb_start_text mode=1 ]
#&f.name_K
「サッカー部？あぁ、もしかして代理のマネージャーって先輩？」[p]
#&f.name
「そう！だけど人が全然来ないの！いつもこんな感じなの？」[p]
[_tb_end_text]

[chara_part  name="かえるくん"  time="200"  face="K_bisyou.png"  mouse="none"  eye="none"  accessory="none"  face_H="none"  accessory_H="none"  ]
[tb_start_text mode=1 ]
#&f.name_K
「……そういうことね？あーはいはい理解しました。先輩、今日はグラウンド練習じゃないですよ」[p]
#&f.name
「え？じゃあどこなの？」[p]
#&f.name_K
「今日は中庭で筋トレと外周です……」[p]
#&f.name
「…………そういうことは前もって言ってよ！あーけんちゃん！」[p]
恥ずかしい気持ちと怒りをこめて空に向かって叫んだ！[p]
[_tb_end_text]
...
[tb_image_show  time="1000"  storage="default/CG/03_Kaeru.png"  width="1280"  height="720"  name="img_53"  ]
[tb_cg  id="031_Ka"  ]
[chara_hide_all  time="200"  wait="false"  ]
[tb_start_text mode=1 ]
#&f.name_K
「じゃあ、次からこうなんないように連絡先交換しとこ」[p]
#&f.name
「えっ！？」[p]
連絡先交換なんてなんかいきなりすぎじゃない！？こんなすいすい交換できるものなの？それとも私がビビってるだけ？[p]
いや、でもかえるくんはコミュ力高いし、それにこの顔面で交換しようとか言われたら誰だってYesジーザス状態……。[p]
#&f.name_K
「……先輩？なにぼーっとしてるんですか。俺に教えるの嫌？」[p]
#&f.name
「違くて、かえるくんは私と交換なんていいのかなって」[p]
#&f.name_K
「あなたと交換したいって俺が言ってるんだから嫌な訳なくない？」[p]
#&f.name
「そ、それはそう……」[p]
#&f.name_K
「はいじゃあQRコード出して。うん、後でなんか送っとくから。早く行こ」[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#&f.name
か、かえるくんと連絡先を交換してしまった……こんなすいすい行っていいのか？[p]
[_tb_end_text]
...
[tb_hide_message_window  ]
[wait  time="500"  ]
[bg  time="1000"  method="fadeInDown"  storage="back/nakaniwa.yugata.png"  cross="true"  ]
...
[tb_show_message_window  ]
[wait  time="500"  ]
[playse  volume="10"  time="1000"  buf="0"  storage="bo-ru_korokoro.mp3"  ]
[tb_start_text mode=1 ]
;[中庭][p]
#サッカー部員
「あ、その人が今日のマネージャー？」[p]
...
[chara_show  name="かえるくん"  time="200"  wait="false"  storage="chara/4/Kb_buk-J.png"  width="700"  height="720"  ]
[chara_part  name="かえるくん"  time="200"  face="K_magao.png"  wait="false"  ]
[tb_start_text mode=1 ]
#&f.name_K
「らしいよ。はい、この通りに今日筋トレ進めてって」[p]
[_tb_end_text]
