;メッセージレイヤの定義
		...
		[position width=1050 height=252 top=422 left=115 ]


		
			[position page=fore frame="kaiwawaku2.png" margint=70 marginl=50 marginr=50 marginb=10 vertical=false opacity="180" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=209 y=441 bold="bold" edge="undefined" shadow="undefined"]
		...
		;CG・回想用の共通項目
		[eval exp="sf._tb_cg_noimage='noimage10.png'" ]
		[eval exp="sf._tb_replay_noimage='noimage10.png'" ]
		...
		[position layer="message1" width=1050 height=252 top=422 left=115 ]
