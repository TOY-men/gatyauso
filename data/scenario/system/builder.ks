...
[if exp="f.mc_MessageBox=='0'" ]
	[Button_pluginEX2  name="role_button"  ]
	[Button_pluginEX  name="role_button"  role="save"  x="620"  y="423"  width="142"  height="60"  fix="true"  storage="test.ks"  graphic="button/save1.png"  enterimg="button/save2.png"  ]
	[Button_pluginEX  name="role_button"  role="load"  x="780"  y="423"  width="142"  height="60"  fix="true"  storage="test.ks"  graphic="button/lode1.png"  enterimg="button/lode2.png"  ]
	[Button_pluginEX  name="role_button"  role="backlog"  x="940"  y="423"  width="142"  height="60"  fix="true"  storage="test.ks"  graphic="button/backlog1.png"  enterimg="button/backlog2.png"  ]
[else]	
	[Button_pluginEX2  name="role_button"  ]
	[Button_pluginEX  width="142"  height="60"  x="620"  y="423"  fix="true"  storage="test.ks"  graphic="button/save3.png"  enterimg="button/save4.png"  name="role_button"  role="save"  ]
	[Button_pluginEX  name="role_button"  role="load"  x="780"  y="423"  width="142"  height="60"  fix="true"  storage="test.ks"  graphic="button/lode3.png"  enterimg="button/lode4.png"  ]
	[Button_pluginEX  name="role_button"  role="backlog"  x="940"  y="423"  width="142"  height="60"  fix="true"  storage="test.ks"  graphic="button/backlog3.png"  enterimg="button/backlog4.png"  ]
[endif]
[endmacro]
