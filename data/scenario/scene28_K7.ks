[_tb_system_call storage=system/_scene28_K7.ks]
...
[tb_image_show  time="1000"  storage="default/CG/28_Kaeru.png"  width="1280"  height="720"  name="img_14"  ]
[tb_cg  id="281_Ka"  ]
[tb_start_text mode=1 ]
#&f.name
「そんな残念な顔だと思わなかった！」[p]
...
[playse  volume="100"  time="1000"  buf="0"  storage="konnkuri_hasiru1.mp3"  ]
[wait  time="2000"  ]
...
[tb_start_text mode=1 ]
#&f.name
ごめんなさいかえるくん！人は顔が全てじゃないし、かえるくんの性格がいいのも分かってるの！[p]
でも、でも……！[p]
やっぱりビジュは大事〜！！！[p]
[_tb_end_text]

[chara_hide  name="かえるくん"  time="1"  wait="false"  pos_mode="false"  ]
[chara_show  name="かえるくん"  time="1"  wait="true"  storage="chara/4/Khb_sei-J.png"  width="700"  height="720"  ]
[chara_part  name="かえるくん"  time="1"  mouse="none"  eye="none"  face="K_egao.png"  accessory="none"  face_H="Kh_mentaruBreak.png"  accessory_H="Kh_ase.png"  ]
...
[tb_start_text mode=1 ]
#&f.name_K
「気軽に外せちゃうしねぇ、どうしようか」[p]
「コスト的な面を考えるとこれ以上失敗するのも危ないかも」[p]
#？？？
｢いやー、雰囲気出てたと思うんだけどな。お前フェロモンが足らないんじゃないのか？｣[p]
[_tb_end_text]
...
[chara_part  name="かえるくん"  time="200"  mouse="none"  eye="none"  face="K_egao.png"  accessory="none"  face_H="Kh_mentaruBreak.png"  accessory_H="none"  ]
[tb_start_text mode=1 ]
#&f.name_K
「そうねぇ。はぁ…そうじゃないと……俺……誰…れて……く……い。よな。」[p]
